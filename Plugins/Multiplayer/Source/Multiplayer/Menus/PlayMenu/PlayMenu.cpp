...
bool UPlayMenu::Initialize()
{
	...
	GetScrollBoxMenu()->SetVisibility(ESlateVisibility::Hidden);
...
void UPlayMenu::JoinMenuBackButtonPressed()
{
	...
	GetScrollBoxMenu()->GetBackButton()->OnClicked.AddDynamic(this, &ThisClass::JoinMenuBackButtonPressed);
...
void UPlayMenu::OnJoinSessionButtonClicked()
{
	...
	GetScrollBoxMenu()->SetVisibility(ESlateVisibility::Visible);
...
void UPlayMenu::FindSessionCompleteCallback(const TArray<FOnlineSessionSearchResult>& SessionResults, bool bWasSuccessful)
{
	...
	//GetScrollBoxMenu()->FillScrollBox(SessionResults);
